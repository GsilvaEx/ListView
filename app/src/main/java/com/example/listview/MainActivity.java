...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_checked, equipes);
    ...
    private ArrayList<String> preencherdados() {
        ...
        dados.add("Gears of War");
        dados.add("Darksouls");
        dados.add("Overwatch");
        dados.add("The Witcher");
        dados.add("FrostPunk");
